...
module	easyaxil_nowrite #(
		...
		//
		input	wire	[C_AXI_DATA_WIDTH-1:0]		gauss_a,
		input	wire	[C_AXI_DATA_WIDTH-1:0]		gauss_b,
		input	wire	[C_AXI_DATA_WIDTH-1:0]		gauss_c,
		input	wire	[C_AXI_DATA_WIDTH-1:0]		gauss_4,
		input	wire	[C_AXI_DATA_WIDTH-1:0]		gauss_3,
		input	wire	[C_AXI_DATA_WIDTH-1:0]		gauss_2,
		input	wire	[C_AXI_DATA_WIDTH-1:0]		gauss_1,
		input	wire	[C_AXI_DATA_WIDTH-1:0]		gauss_0
		// }}}
	);
