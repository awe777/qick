...
set_property PACKAGE_PIN N14       [get_ports "PL_I2C0_SDA_LS"] ;# Bank  88 VCCO - VCC1V8   - IO_L1N_AD15N_88
set_property IOSTANDARD  LVCMOS18  [get_ports "PL_I2C0_SDA_LS"] ;# Bank  88 VCCO - VCC1V8   - IO_L1N_AD15N_88
set_property PACKAGE_PIN N16       [get_ports "PL_I2C0_SCL_LS"] ;# Bank  88 VCCO - VCC1V8   - IO_L1P_AD15P_88
set_property IOSTANDARD  LVCMOS18  [get_ports "PL_I2C0_SCL_LS"] ;# Bank  88 VCCO - VCC1V8   - IO_L1P_AD15P_88
...
set_property PULLUP true 			[get_ports "PL_I2C0_SDA_LS"]
set_property PULLUP true 			[get_ports "PL_I2C0_SCL_LS"]
...
# set_property PACKAGE_PIN G13 [get_ports {pmod_output_0[4]}]
# set_property PACKAGE_PIN H15 [get_ports {pmod_output_0[3]}]
# set_property PACKAGE_PIN H14 [get_ports {pmod_output_0[2]}]
# set_property PACKAGE_PIN G16 [get_ports {pmod_output_0[1]}]
# set_property PACKAGE_PIN G15 [get_ports {pmod_output_0[0]}]
# set_property IOSTANDARD LVCMOS18 [get_ports {pmod_output_0[7]}]
# set_property IOSTANDARD LVCMOS18 [get_ports {pmod_output_0[6]}]
# set_property IOSTANDARD LVCMOS18 [get_ports {pmod_output_0[5]}]
# set_property IOSTANDARD LVCMOS18 [get_ports {pmod_output_0[4]}]
# set_property IOSTANDARD LVCMOS18 [get_ports {pmod_output_0[3]}]
# set_property IOSTANDARD LVCMOS18 [get_ports {pmod_output_0[2]}]
# set_property IOSTANDARD LVCMOS18 [get_ports {pmod_output_0[1]}]
# set_property IOSTANDARD LVCMOS18 [get_ports {pmod_output_0[0]}]
set_property PACKAGE_PIN E25 [get_ports {led_output_0[7]}]
set_property PACKAGE_PIN BB12 [get_ports {led_output_0[6]}]
set_property PACKAGE_PIN AY16 [get_ports {led_output_0[5]}]
set_property PACKAGE_PIN AW12 [get_ports {led_output_0[4]}]
set_property PACKAGE_PIN AU16 [get_ports {led_output_0[3]}]
set_property PACKAGE_PIN AP14 [get_ports {led_output_0[2]}]
set_property PACKAGE_PIN AP16 [get_ports {led_output_0[1]}]
set_property PACKAGE_PIN AN14 [get_ports {led_output_0[0]}]
set_property IOSTANDARD LVCMOS12 [get_ports {led_output_0[7]}]
set_property IOSTANDARD LVCMOS12 [get_ports {led_output_0[6]}]
set_property IOSTANDARD LVCMOS12 [get_ports {led_output_0[5]}]
set_property IOSTANDARD LVCMOS12 [get_ports {led_output_0[4]}]
set_property IOSTANDARD LVCMOS12 [get_ports {led_output_0[3]}]
set_property IOSTANDARD LVCMOS12 [get_ports {led_output_0[2]}]
set_property IOSTANDARD LVCMOS12 [get_ports {led_output_0[1]}]
set_property IOSTANDARD LVCMOS12 [get_ports {led_output_0[0]}]

####################################################################################
# Constraints from file : 'd_1_ddr4_0_0_board.xdc'
####################################################################################

#current_instance d_1_i/ddr4_0/inst
